...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('styles/backsite.css') }}">
    <link rel="shortcut icon" href="{{ asset('images/icon.ico') }}" type="image/x-icon">
</head>

<body class="bg-gray-100">
    @include('backsite.layouts.partials.navbar')

    <div class="h-screen flex flex-row flex-wrap">
        @include('backsite.layouts.partials.sidebar')
    ...
    @include('backsite.layouts.partials.footer')

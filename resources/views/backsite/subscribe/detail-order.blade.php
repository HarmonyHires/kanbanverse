...
<head>
    ...
    <title>KanbanVerse | Order - {{ $plan->name_plan }}</title>
        ...
        <div class="container mx-auto px-4 my-12">
            ...
            <div class="flex gap-5 mt-5 lg:flex-row flex-col">
                ...
                <div class="bg-dark_navy w-full lg:w-1/3 shadow p-10 text-white rounded-sm mt-2 lg:mt-0">
                    ...
                    <div class="mt-5 flex flex-col justify-around h-full">
                        <div>
                        ...
                        <div class="flex flex-col gap-6">
                            ...
                            <button class="bg-white text-dark_navy p-3 w-full rounded-sm">Proceed to Payment</button>
                        </div>
                    </div>
                </div>
            </div>
